...
<html lang="en">
<head>
<title>BUDDHA RESORT | HOME</title>
<!-- for-mobile-apps -->
...
<div class="container-fluid" style="height:50px;">
	<div class="social-bnr-agileits">
			<ul class="social-icons3">
				...
				<li><a href="http://www.rssnepal.org.np/" class="fa fa-rss icon-border rss"> </a></li>
			</ul>
	</div>
...
<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@buddharesort.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+977 9808653478</li>	
					<li class="s-bar">
						<div class="search">
...
<div class="clearfix">
	<nav class="navbar  apnav navbar-inverse" data-spy="affix" data-offset-top="197">
		<div class="navbar-header navbar-left">
			...
			<h1><a class="navbar-brand" href="index.php">Bud<span>dha</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
		</div>
		...
		<div class="collapse  navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
			<nav class="menu menu--iris">
				<ul class="nav  navbar-nav menu__list">
					...
					<li class="menu__item"><a href="admin/home.php" target="_blank" class="menu__link">Admin</a></li>
				</ul>
			</nav>
		</div>
	</nav>
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<p>Providing guests unique and enchanting views from their 
											rooms with its exceptional amenities, makes Buddha Resort
											 one of bests in its kind.Try our food menu, awesome 
											 services and friendly staff while you are here.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">BUDDHA</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">MOUNTAIN BALCONY</h4>
							<span class="cbp-ig-category">BUDDHA</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our BUDDHA RESORT</h3> 
						   ...
						   <img src="images/ab.jpg" style="height:450px; width:100%" class="img-responsive" alt="Hair Salon">
										<div class="w3l-slider-img">
											<img src="images/ab1.jpg" style="height:400px; width:550px" alt="Hair Salon">
										</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+977 9089754376</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">info@buddharesort.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Phulbari Chowk, Pokhara</p>
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3535.3818710296696!2d83.37047921506003!3d27.612687382831133!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39968f3ab2a1b301%3A0x592e9e03266fcbad!2sBuddha%20Village%20Cottage%20and%20Party%20Palace%20Pvt.%20Ltd.!5e0!3m2!1sen!2snp!4v1620809097747!5m2!1sen!2snp" 
...
<!-- /contact -->
			<div class="copy">
		        <p>&copy; 2021 BUDDHA RESORT . All Rights Reserved | Design by <a href="index.php">BUDDHA</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
